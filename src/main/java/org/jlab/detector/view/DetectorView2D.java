...
import static org.jlab.groot.graphics.GraphicsAxis.AXISTYPE_COLOR;
...
public class DetectorView2D extends JPanel implements MouseMotionListener {
    ...
    public Map<String,DetectorViewLayer2D>  viewLayers = new LinkedHashMap<String,DetectorViewLayer2D>();
    ...
    public GraphicsAxis                        colorAxis   = new GraphicsAxis(AXISTYPE_COLOR);
    ...
    public static class DetectorViewLayer2D {
        ...
        private LinkedList<DetectorShape2D> shapesList = null; 
        protected IndexedList<DetectorShape2D>  shapes  = null;
        ...
        public DetectorViewLayer2D() {
            ...
            shapesList = new LinkedList<DetectorShape2D>(); 
        }
        /**
        ...
        public LinkedList<DetectorShape2D> getShapes(){
